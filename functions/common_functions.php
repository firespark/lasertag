...
function custom_theme_setup(){
    ...
    load_theme_textdomain( 'lasertag', get_template_directory() . '/languages' );
    ...
    if(function_exists('acf_add_options_page')){
        acf_add_options_page([
            'page_title' => __('Main settings', 'lasertag'),
            'menu_title' => __('Main settings', 'lasertag'),
            'update_button'   => __('Save', 'lasertag'),
...
function custom_breadcrumbs($args = []) {
    ...
    /* === Options === */
    $text['home'] = __('Home', 'lasertag');
    $text['category'] = '%s';
    $text['search'] = __('Search results with query', 'lasertag') . ' "%s"';
    $text['tag'] = __('Posts with tag', 'lasertag') . ' "%s"';
    $text['author'] = __('Authors posts', 'lasertag') . ' %s';
    $text['404'] = __('Error', 'lasertag') . ' 404';
    $text['page'] = __('Page', 'lasertag') . ' %s';
    $text['cpage'] = __('Comments page', 'lasertag') . ' %s';
...
function pagination_admin_panel($page, $paged, $get_par, $total_pages){
    $pagination = '<span>' . __('Pages', 'lasertag') . ': </span>';
    if ($paged !== 1){$pagination .= '<a href="/wp-admin/admin.php?page=' . $page . $get_par . '" title="' . __('First page', 'lasertag') . '">&lt;&lt;&lt;</a>';}
    ...
    if($paged !== $total_pages){
        $pagination .= '<a href="/wp-admin/admin.php?page=' . $page . '&paged=' . $total_pages . $get_par . '" title="' . __('Last page', 'lasertag') . '">&gt;&gt;&gt;</a>';
    }
    return $pagination;
}